  ...
  <div id="app">
      ...
      >
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item">
              <a class="nav-link scroll text-light" href="#projects"
                >projects</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link scroll text-light" href="#portfolio"
                >references</a
              >
            </li>
            <li class="nav-item">
              <a class="nav-link scroll text-light" href="#partners"
                >technologies</a
              >
            </li>
          </ul>
          ...
          <form class="form-inline my-2 my-lg-0">
            <ul class="navbar-nav mr-auto">
              <li class="nav-item">
                <a class="nav-link scroll text-light" href="#contact"
                  >contact</a
                >
              </li>
            </ul>
    ...
    <div id="landing" class="container-fluid text-center parallax">
      <div class="container text-light text-shadow">
        <div class="wrap">
          <h1 class="display-3 text-uppercase"><b>Virtus d.o.o</b></h1>
          <h3>
            creating sustainable, high quality software solutions with modern
            design
          </h3>
          <a href="#projects">
            <svg
    ...
    <div id="projects">
      <div class="container text-center py-5">
        <h1 class="display-3 pt-5 pb-3 module">Projects</h1>

        <div class="project-1 mt-5">
          <h2 class="module">Polygon NFTs</h2>
          <h5><span class="badge badge-secondary my-3">2020.</span></h5>
          <p class="mx-5 my-4">
            E-commerce music website with a ton of traffic that generates
            millions of dollars worth of revenue per year. Gorgeous UI/UX, admin
            panel, stable backend, scalable database and fast loading is what
            separates Shoply from the rest of e-commerce websites
          </p>
        ...
        <div class="project-2 mt-5 pt-5">
          <h2 class="module">Statrak</h2>
          <h5><span class="badge badge-secondary my-2">2021.</span></h5>
          <p class="mx-5 my-4">
            Customized admin panel for tracking specialized data for logistics
            and traffic. Highly configurable and secure.
          </p>
    ...
    <div id="portfolio">
      <div class="container-fluid py-5" style="background-color: #80c4ec">
        <div class="container text-center">
          <h1 class="display-3 text-light text-shadow module pt-5 pb-3">
            References
          </h1>
          ...
          <div class="row justify-content-around my-3">
            <div class="col-md-3 bg-light shadow py-3 px-5 module">
              ...
              <h2>Lines<br />of code</h2>
              <p class="display-1 accentColor">800k</p>
            </div>
            <div class="col-md-3 bg-light shadow py-3 px-5 module">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <h2>Projects<br />launched</h2>
              <p class="display-1 accentColor">60+</p>
            </div>
            <div class="col-md-3 bg-light shadow py-3 px-5 module">
              <svg
                xmlns="http://www.w3.org/2000/svg"
              ...
              <p class="display-1 accentColor">24</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div id="timeline" class="mt-5">
        <div class="container">
          <div class="page-header my-3">
            <h2 class="accentColor text-center module">
              Journey to get your
              <b>dream software solution</b>
            </h2>
          </div>
          <ul class="timeline">
            <li>
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p>
                    Contact us, find out all the info about the development
                    process, get your qoute and initial questions answered
                  </p>
                  <br />
                  <a href="#contact" class="scroll"
                    ><button
                      class="btn btn-secondary"
                      style="background-color: #80c4ec; border-color: #80c4ec"
                    >
                      Contact us
                    </button></a
                  >
            ...
            <li class="timeline-inverted">
              ...
              <div class="timeline-panel">
                ...
                <div class="timeline-body">
                  <p>
                    You deliver your document of specification, we brush up on
                    details to fully understand your needs
                  </p>
                  <hr />
                  <p>
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      class="bi bi-arrow-repeat mr-1 mb-1"
                      viewBox="0 0 16 16"
                    >
                      <path
                    ...
                    Repeat until a perfect solution has been found
                  </p>
                </div>
              </div>
            </li>
            <li>
              ...
              <div class="timeline-panel">
                <div class="timeline-heading">
                  <h4 class="timeline-title">Development</h4>
                </div>
                <div class="timeline-body">
                  <p>
                    Development process, time dependant on the project
                    requirements
                  </p>
                  <hr />
                  <p>
                    ...
                    Not too late to change your mind about something :p!
                  </p>
                </div>
              </div>
            </li>
            <li class="timeline-inverted">
              <div class="timeline-badge success">
                <svg
                  ...
                  height="24"
                  fill="currentColor"
                  class="bi bi-house-door-fill mb-1"
                  viewBox="0 0 16 16"
                >
                  <path
                ...
                <div class="timeline-heading">
                  ...
                  <p>
                    <svg
                      ...
                      height="16"
                      fill="currentColor"
                      class="bi bi-clock-fill mb-1 mr-1"
                      viewBox="0 0 16 16"
                    >
                      <path
                        fill-rule="evenodd"
                    ...
                    <span class="small">Within due date</span>
                  </p>
                </div>
                <div class="timeline-body">
                  <p>
                    Project delivery, top notch product that meets all your
                    needs
                  </p>
                </div>
              </div>
    ...
    <div id="partners" style="background-color: #80c4ec">
      <div class="container-fluid py-5">
        <div class="container">
          ...
          <p class="lead text-center text-light px-5 module">
            Many technologies have been used in our environment, but we have to
            thank our most popular ones.
          </p>
    ...
    <div id="contact">
      ...
      <!-- test -->
      <div class="container text-center border-bottom pb-150">
        <div class="wrap my-5">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            width="64"
          ...
          <h6>
            You can always contact us via email and expect a fast response
          </h6>
          ...
          <b-form @submit.prevent="post" @keyup.enter="post" class="form">
            ...
            <b-form-group id="input-group-3" label-for="input-3" class="my-4">
              <b-form-textarea
                class="rounded-0"
                rows="4"
                id="input-3"
      ...
      <div class="contact-main container text-center">
        <div class="row justify-content-around">
          <div class="col-md-5 border bg-light module">
            <div class="wrap">
              ...
              <h2>Call us</h2>
              <h3>
                <b><em>+387 63 121-212</em></b>
              </h3>
              <h6>
                Getting information regarding your questions has never been this
                easy
              </h6>
            </div>
          </div>
        ...
        <div class="wrap module">
          ...
          <h3>
            ...
            <b><em>Stjepana Radića 44, Mostar</em></b>
          </h3>
          <h6>
            You can get the fastest support by visiting and chatting with our
            specialized staff
          </h6>
          <h6 class="small text-uppercase text-muted">Work hours: 08-16h</h6>
          <a
            href="https://www.google.com/maps/dir//43.4713641,17.3221491/@43.4714069,17.3221813,18z/data=!4m2!4m1!3e2"
            target="_blank"
            ><button
              class="btn-light btn px-4 my-4"
              style="background-color: #80c4ec; border-color: #80c4ec"
            >
              Visit us
            </button></a
    ...
    <!-- footer -->
    <div id="footer">
      <div class="container-fluid block py-2 bg-dark text-center">
        <div class="container">
          <div class="row py-3">
            <div class="col-md-6">
              <a href="#"
        ...
        <p class="small text-center pt-3 text-muted">
          Virtus d.o.o 2021. © All rights reserved
        </p>
      </div>
    </div>
  </div>
